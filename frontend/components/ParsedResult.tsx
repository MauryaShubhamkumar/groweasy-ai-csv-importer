  ...
  return (
    <div className="mt-10">
      ...
      <div className="mt-4 grid gap-4 sm:grid-cols-2">
        ...
        <div className="rounded-lg border bg-white p-4">
          <p className="text-sm text-gray-500">Total Skipped</p>
      ...
      <div className="mt-6 max-h-[500px] overflow-auto rounded-xl border border-gray-200">
            ...
            {records.map((record, index) => (
              <tr key={index} className="border-b hover:bg-gray-50">
                {headers.map((header) => (
                  <td
                    key={header}
                    className="max-w-[250px] truncate whitespace-nowrap px-4 py-3 text-gray-600"
                  >
                    {record[header] || "-"}
                  </td>
                ))}
      ...
      {skippedRecords.length > 0 && (
        <div className="mt-8">
          ...
          <div className="max-h-[400px] overflow-auto rounded-xl border border-gray-200">
            <table className="min-w-max w-full text-sm">
              <thead className="sticky top-0 bg-gray-100">
                <tr>
